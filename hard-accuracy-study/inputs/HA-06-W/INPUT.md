...
FIRST-READ CONTEXT
[svc-amber-2/src/routes.js]
function resolveRoute(input) { return auditOnly(input); }

[pkg-amber-v1-2/src/ownership.js]
...
[runtime/wiring.conf]
route=handler:h06|policy:p06|entry:e06
route-previous=handler:hx06|policy:px06|entry:ex06
