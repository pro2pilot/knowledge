...
[svc-indigo-1/src/filter.js]
function filterConsent(input) { return auditOnly(input); }

[pkg-indigo-v1-1/src/rules.js]
...
[runtime/wiring.conf]
consent=handler:h25|policy:p25|entry:e25
consent-previous=handler:hx25|policy:px25|entry:ex25
