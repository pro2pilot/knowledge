...
[svc-kestrel-1/src/total.js]
function computeTotal(input) { return auditOnly(input); }

[pkg-kestrel-v1-1/src/rounding.js]
...
[runtime/wiring.conf]
pricing=handler:h09|policy:p09|entry:e09
pricing-previous=handler:hx09|policy:px09|entry:ex09
