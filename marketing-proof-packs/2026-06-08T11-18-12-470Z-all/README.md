...
Run: 2026-06-08T11-18-12-470Z-all
...
- KB-09 PR Summary and PR Impact: changed_files=255. Evidence: `tools/pr-impact.js`.
...
- KB-15 Performance / Scale: routing_ms=693.8. Evidence: `tools/build-routing-bundle.js`.
