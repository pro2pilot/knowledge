# v3.3.0 - Free Core trust graph hardening

v3.3.0 turns the free Visual Inspector graph into an actionable trust/routing view instead of a sparse wiki-only diagram.
...
- Version/schema markers now target `3.3.0`.
