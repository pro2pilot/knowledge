...
function main() {
  ...
  console.log(JSON.stringify({ schema_version: systemVersion(), status: 'pass', checks: ['Safe Queue default', 'Manual Only merge default', 'workspace registration visible'] }, null, 2));
