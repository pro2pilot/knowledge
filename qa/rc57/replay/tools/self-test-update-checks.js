...
const version = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'package.json'), 'utf8')).version || '3.3.0';
...
function main() {
  ...
  assert.strictEqual(checkUpdates.compareVersions('3.2.12', '3.2.5'), 1, 'patch version comparison must sort multi-digit patches');
