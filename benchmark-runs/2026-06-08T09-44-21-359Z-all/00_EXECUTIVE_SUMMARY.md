# Benchmark run 2026-06-08T09-44-21-359Z-all - Executive summary
...
| PR Impact maps changed files to modules, policy warnings and reviewer notes in a local fixture. | measured-on-fixture | changed_files=191 | tools/pr-impact.js | fixture/local run scope |
...
| Performance / Scale produced a local benchmark result with recorded limitations. | measured | routing_ms=964.6 | tools/build-routing-bundle.js | fixture/local run scope |
