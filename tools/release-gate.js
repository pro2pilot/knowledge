...
const version = JSON.parse(fs.readFileSync(path.join(root, 'package.json'), 'utf8')).version || '3.2.0';
...
function main(argv = process.argv.slice(2)) {
  ...
  const commands = [
    ...
    ['self-test Canonical E2E', [process.execPath, ['tools/self-test-canonical-e2e.js', '--json'], 360000]],
    ['self-test Pro Ready Gates', [process.execPath, ['tools/self-test-pro-ready-gates.js', '--json'], 120000]],
