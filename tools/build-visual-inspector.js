...
function renderTabbed(data, options = {}) {
  ...
  const exportBody = `<div class="quick-actions"><button class="action-card" type="button" data-copy="node .knowledge/tools/validate-release-artifact.js dist/knowledge-v3.2.3.zip --json"><span>Validate Release Artifact</span><code>node .knowledge/tools/validate-release-artifact.js dist/knowledge-v3.2.3.zip --json</code></button></div><div class="empty-state" style="margin-top:14px"><h3>Release artifact hygiene</h3><p>Use the uploaded release asset for install checks; source snapshots are not install packages.</p></div>`;
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>.knowledge Inspector 3.2.3</title>
<style>
